...
export default function ClientSarahJuan() {
  const { statuses } = useTaskStatuses();
  const now = useNow();
  const meta = PROJECTS.sj;
  ...
  return (
    <div className="client-sj-app">
      <div className="header">
        <div className="header-studio">Casa Solstice · Estado del proyecto</div>
        <div className="header-names">Sarah & Juan</div>
        <div className="header-concept">Entre Aquí y Allá · Between here and there, we made a life worth celebrating.</div>
        <div className="header-date">Boda · 21 de agosto de 2027 · Madrid</div>
      ...
      <div className="countdown-strip"><strong>{days} días</strong> para la boda · 21 de agosto de 2027</div>
